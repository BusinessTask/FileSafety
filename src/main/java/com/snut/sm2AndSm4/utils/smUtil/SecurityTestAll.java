...
import com.snut.sm2AndSm4.utils.sm2.SM2EncDecUtils;
import com.snut.sm2AndSm4.utils.sm2.SM2KeyVO;
import com.snut.sm2AndSm4.utils.sm2.SM2SignVO;
import com.snut.sm2AndSm4.utils.sm2.SM2SignVerUtils;
...
public class SecurityTestAll {
    ...
    public static void main(String[] args) throws Exception {
    	//SM2测试
        System.out.println("--产生SM2密钥--:");
        SM2KeyVO sm2KeyVO = SecurityTestAll.generateSM2Key();
        System.out.println("--产生对称算法密钥--");
        ...
        String SM2Enc = SecurityTestAll.SM2Enc(sm2KeyVO.getPubHexInSoft(), src);
        System.out.println("加密:");
        System.out.println("密文:" + SM2Enc);
        String SM2Dec = SecurityTestAll.SM2Dec(sm2KeyVO.getPriHexInSoft(), SM2Enc);
        System.out.println("解密:");
        System.out.println("明文:" + SM2Dec);
        System.out.println("原文UTF-8转hex:" + Util.byteToHex(sm4Key.getBytes()));
        String SM2Enc2 = SecurityTestAll.SM2Enc(sm2KeyVO.getPubHexInSoft(), sm4Key);
        System.out.println("加密:");
        System.out.println("密文:" + SM2Enc2);
        String SM2Dec2 = SecurityTestAll.SM2Dec(sm2KeyVO.getPriHexInSoft(), SM2Enc2);
        System.out.println("解密:");
        System.out.println("明文:" + SM2Dec2);
        ...
        SM2SignVO sign = SecurityTestAll.genSM2Signature(sm2KeyVO.getPriHexInSoft(), s5);
