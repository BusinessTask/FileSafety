                                ...
                                s.render({
                                    ...
                                    before: function(t) {
                                        ...
                                        if (i.close(r), 0 == t.code) t.data = t.data || {},
                                            ...
                                            area: ["390px", "260px"],
                                            offset: "t",
                                            content: t.msg + "<div><audio src='" + t.data.src + "' controls='controls'/></div>确定使用该文件吗？",
                                            btn: ["确定", "取消"],
                                            yes: function() {
                                                t.data = t.data || {},
                                                    c.val(t.data.src),
                                    ...
                                    l.find(".layedit-btn-yes").on("click",
                                        function() {
                                            ...
                                            e(a).parent();
                                            h.call(t, "p", {
                                                    text: '&nbsp;<audio src="' + c.val() + '" controls="controls" >您的浏览器不支持audio播放</audio>&nbsp;'
                                                },
                                                n),
                                                i.close(o)
                                        })
